function [x_t,f_t,res] = AFW(x_0, S_0, alpha_0, A, b, fun_optim, opts) 
% [x_t,f_t,res] = AFW(x_0, S_0, alpha_0, A, b, fun_optim, opts) 
% -> res: objective tracking
%
% This code runs away-steps FW (Algorithm 1 in paper). 
%
% objective is: 0.5 x' A x + b' x
%
% [x_t, f_t] = AFW(x_0, S_0, alpha_0, A, fun_optim, opts) 
